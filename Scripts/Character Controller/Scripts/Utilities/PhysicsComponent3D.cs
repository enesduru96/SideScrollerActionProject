...
namespace ShadowFort.Utilities
{
    ...
    public sealed class PhysicsComponent3D : PhysicsComponent
    {
        ...
        readonly ContactPoint[] _contactsBuffer = new ContactPoint[20];
        readonly RaycastHit[] _hitsBuffer = new RaycastHit[20];
        readonly Collider[] _overlapsBuffer = new Collider[20];
