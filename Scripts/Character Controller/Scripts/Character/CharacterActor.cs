...
public class CharacterActor : PhysicsActor
{
    ...
    [Header("Animation and State Locks")]
    public bool BusyCombatStateTransitionLocked;
    public bool BusyComboLocked;
    public bool BusyInputLocked;
    public bool BusyAnimStateLocked;
    public bool BusyAnimStateLockedRootMotion;
    public bool BusyReturnToIdleLocked;


    public bool IsFacingRight()
    {
        var CP = Vector3.Cross(Forward, Up);
        return CP.z > 0f;
    }
    ...
    {
        var CP = Vector3.Cross(Up, WallContact.normal);
        return CP.z > 0f;
    }
    ...
    public bool ObjectIsRightSide(Transform obj)
    {
        return obj.position.x > Position.x;
    }
    public bool ObjectIsLeftSide(Transform obj)
    {
        return obj.position.x < Position.x;
    }
    ...
    public string GetCharacterInfo()
    {
        ...
        stringBuilder.AppendLine("Ground :");
        stringBuilder.AppendLine("──────────────────");
        stringBuilder.Append("Is Grounded: ").Append(IsGrounded).Append("\n");
        stringBuilder.Append("Is Stable: ").Append(IsStable).Append("\n");
        stringBuilder.Append("Slope Angle: ").Append(characterCollisionInfo.groundSlopeAngle).Append("\n");
        stringBuilder.Append("Is On Edge: ").Append(characterCollisionInfo.isOnEdge).Append("\n");
        stringBuilder.Append("Edge Angle: ").Append(characterCollisionInfo.edgeAngle).Append("\n");
        stringBuilder.Append("Ground Object Name: ").Append(characterCollisionInfo.groundObject?.name ?? NULL_STRING).Append("\n");
        stringBuilder.Append("Ground Object Tag: ").Append(characterCollisionInfo.groundObject?.tag ?? NULL_STRING).Append("\n");
        stringBuilder.Append("Layer: ").Append(LayerMask.LayerToName(characterCollisionInfo.groundLayer)).Append("\n");
        stringBuilder.Append("Rigidbody Type: ").Append(GroundRigidbodyComponent != null ? (GroundRigidbodyComponent.IsKinematic ? "Kinematic" : "Dynamic") : NULL_STRING).Append("\n");
        stringBuilder.Append("Dynamic Ground: ").Append(GroundRigidbodyComponent != null ? "Yes" : "No").Append("\n\n");

        stringBuilder.Append("Character Forward: ").Append(transform.forward.x.ToString("F2")).Append(", ")
                     .Append(transform.forward.y.ToString("F2")).Append(", ")
                     .Append(transform.forward.z.ToString("F2")).Append("\n");

        // **Wall Section**
        stringBuilder.AppendLine("Wall :");
        stringBuilder.AppendLine("──────────────────");
        stringBuilder.Append("Wall Collision: ").Append(characterCollisionInfo.wallCollision).Append("\n");
        stringBuilder.Append("Is on Ledge: ").Append(this.IsOnLedge).Append("\n");
        stringBuilder.Append("Wall Angle: ").Append(characterCollisionInfo.wallAngle).Append("\n");
        stringBuilder.Append("Wall Object: ").Append(characterCollisionInfo.wallContact.gameObject?.name ?? NULL_STRING).Append("\n");
        stringBuilder.Append("Wall Object Tag: ").Append(characterCollisionInfo.wallContact.gameObject?.tag ?? NULL_STRING).Append("\n");
        stringBuilder.Append("Wall Contact Caused Velocity: ")
                     .Append(characterCollisionInfo.wallContact.pointVelocity.x.ToString("F2")).Append(", ")
                     .Append(characterCollisionInfo.wallContact.pointVelocity.y.ToString("F2")).Append(", ")
                     .Append(characterCollisionInfo.wallContact.pointVelocity.z.ToString("F2")).Append("\n");
        stringBuilder.Append("Wall Contact Relative Velocity: ")
                     .Append(characterCollisionInfo.wallContact.relativeVelocity.x.ToString("F2")).Append(", ")
                     .Append(characterCollisionInfo.wallContact.relativeVelocity.y.ToString("F2")).Append(", ")
                     .Append(characterCollisionInfo.wallContact.relativeVelocity.z.ToString("F2")).Append("\n\n");

        // **Head Section**
        stringBuilder.AppendLine("Head :");
        stringBuilder.AppendLine("──────────────────");
        stringBuilder.Append("Head Collision: ").Append(characterCollisionInfo.headCollision).Append("\n");
        stringBuilder.Append("Head Collision Object: ").Append(characterCollisionInfo.headContact.gameObject?.name ?? NULL_STRING).Append("\n");
        stringBuilder.Append("Head Collision Tag: ").Append(characterCollisionInfo.headContact.gameObject?.tag ?? NULL_STRING).Append("\n");
        stringBuilder.Append("Head Angle: ").Append(characterCollisionInfo.headAngle).Append("\n");
        stringBuilder.Append("Head Contact Caused Velocity: ")
                     .Append(characterCollisionInfo.headContact.pointVelocity.x.ToString("F2")).Append(", ")
                     .Append(characterCollisionInfo.headContact.pointVelocity.y.ToString("F2")).Append(", ")
                     .Append(characterCollisionInfo.headContact.pointVelocity.z.ToString("F2")).Append("\n");
        stringBuilder.Append("Head Contact Relative Velocity: ")
                     .Append(characterCollisionInfo.headContact.relativeVelocity.x.ToString("F2")).Append(", ")
                     .Append(characterCollisionInfo.headContact.relativeVelocity.y.ToString("F2")).Append(", ")
                     .Append(characterCollisionInfo.headContact.relativeVelocity.z.ToString("F2")).Append("\n\n");

        // **Triggers Section**
        stringBuilder.AppendLine("Triggers :");
        stringBuilder.AppendLine("──────────────────");
        for (int i = 0; i < Triggers.Count; i++)
        {
            var triggerGO = Triggers[i].gameObject;
            if (triggerGO != null)
                stringBuilder.Append(" - ").Append(triggerGO.name).Append("\n");
        }

        // **Timers Section**
        stringBuilder.AppendLine("Timers :");
        stringBuilder.AppendLine("──────────────────");
        stringBuilder.Append("On Ledge Time: ").Append(this.OnLedgeTime.ToString("F2")).Append("\n");
        stringBuilder.Append("Not on Ledge Time: ").Append(this.NotOnLedgeTime.ToString("F2")).Append("\n");
        stringBuilder.Append("Grounded Time: ").Append(this.GroundedTime.ToString("F2")).Append("\n");
        stringBuilder.Append("Not Grounded Time: ").Append(this.NotGroundedTime.ToString("F2")).Append("\n");
    ...
    public float NotOnLedgeTime { get; private set; }
    public float OnLedgeTime { get; private set; }
    ...
    public void SetAnimancer(AnimancerComponent animancer)
    {
        if (animancer == null)
            return;
    ...
    protected override void Awake()
    {
        ...
        var animancer = this.GetComponentInBranch<CharacterActor, AnimancerComponent>();
        SetAnimancer(animancer);
